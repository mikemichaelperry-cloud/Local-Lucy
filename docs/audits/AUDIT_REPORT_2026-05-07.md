...
**Scope:** Full codebase (`ui-v10/app/`, `tools/`, `config/`, state management, voice pipeline, routing, memory, tests)  
...
**Fix:** Eliminate the snapshot-as-runtime-root pattern. The UI should run directly from `tools/` and `ui-v10/app/`. The snapshot should be a read-only backup or generated artifact, not a dual source of truth.

### 1.2 Critical: UI Hardcodes Paths into Snapshot Directory

**Files:**
- `ui-v10/app/main_window.py:346` — kokoro socket path
- `ui-v10/app/main_window.py:360` — whisper PID file path
- `ui-v10/app/backend/news_provider.py:5`
- `ui-v10/app/backend/state_manager.py:5`
- `ui-v10/app/backend/streaming_voice.py:6`
- `ui-v10/app/services/runtime_bridge.py:132` — whitelists `"opt-experimental-v9-dev"`
...
| `ui-v10/app/services/runtime_bridge_consolidated.py` | `asyncio`, `tempfile` |
...
**File:** `ui-v10/app/services/runtime_bridge_consolidated.py:598-665` (`_set_state_field`)  
...
**Files:**
- `ui-v10/app/services/runtime_bridge.py:872-897`
- `ui-v10/app/services/runtime_bridge_consolidated.py:694-758`
...
**File:** `ui-v10/app/services/runtime_bridge_consolidated.py`  
...
**File:** `ui-v10/app/services/state_store.py:229-331`  
...
**File:** `ui-v10/app/services/state_store.py:435-452` (`_load_json`)  
...
**File:** `ui-v10/app/services/runtime_bridge.py:899-909` (`_resolve_current_model`)  
...
**File:** `ui-v10/tests/test_interface_level_layout_offscreen.py`  
...
| `ui-v10/tests/*` | 0 | 0 | 0 collected (display/offscreen issues) |
