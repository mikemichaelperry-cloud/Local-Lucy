...
try:
    ...
    from voice.playback import play_wav_file, PlaybackError, detect_audio_player
except ImportError:
    tts_adapter = None
    play_wav_file = None
...
class VoicePipeline(BaseToolWrapper):
    ...
    def _strip_html_for_tts(self, text: str) -> str:
        ...
        Converts HTML content to plain text suitable for speech synthesis.
        """
        import re
    ...
    def _resolve_voice_python(self) -> str:
        ...
        # ISOLATION: Hard fail if ui-v8 not found
        raise RuntimeError(
