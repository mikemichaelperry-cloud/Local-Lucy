...
def requires_evidence_mode(query: str, context: dict | None = None) -> tuple[bool, str]:
    ...
    if any(p in normalized for p in memory_pet_phrases):
        ...
        personal_pet_phrases = [
            ...
            "is my cat hungry",
            "when did i get my dog",
            "when did i get my cat",
        ]
        if any(p in normalized for p in personal_pet_phrases):
            return False, "personal_family_context"

        # Recreational / outing pet queries are personal, not veterinary.
        # Catches "should I take my dog for a walk", "what can I do with my dog today",
        # "my cat wants to play", etc.
        recreational_pet_indicators = [
            ...
            "what can i do with the dog",
            "fun things to do with my dog",
            "fun with my dog",
            " outing with my dog",
            "outing with the dog",
            "should i walk",
