...
_SELF_KNOWLEDGE_TEMPLATE = (
    ...
    "with optional synthesis by OpenAI/Kimi), NEWS, TIME, WEATHER, FINANCE, EVIDENCE. "
    "Do not ask the user to pick a mode.\n"
    "Capabilities: coding, writing, reasoning, voice, tube database (648 types), "
    "live data via AUGMENTED/NEWS/WEATHER, and travel/destination answers from trusted sources.\n"
