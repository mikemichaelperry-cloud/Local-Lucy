...
# Configuration
SNAPSHOT_ROOT = Path("/home/mike/lucy-v9")
UI_ROOT = Path("/home/mike/lucy-v9/ui-v9")
RUNTIME_NS = Path("/home/mike/.codex-api-home/lucy/runtime-v9")
...
def main():
    ...
    print("=" * 60)
    print("  1. Launch HMI: cd /home/mike/lucy-v9/ui-v9 && source .venv/bin/activate && python app/main.py")
