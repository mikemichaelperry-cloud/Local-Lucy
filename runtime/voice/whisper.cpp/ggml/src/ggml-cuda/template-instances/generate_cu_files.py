...
SOURCE_FATTN_MMA_CASE = (
    "DECL_FATTN_MMA_F16_CASE({head_size_kq}, {head_size_v}, {ncols1}, {ncols2});\n"
)
...
for type_k in TYPES_KV:
    for type_v in TYPES_KV:
        with open(
            f"fattn-vec-instance-{get_short_name(type_k)}-{get_short_name(type_v)}.cu", "w"
        ) as f:
