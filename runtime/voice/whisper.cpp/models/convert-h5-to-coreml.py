...
spec = importlib.util.spec_from_file_location(
    "whisper_to_coreml", "models/convert-whisper-to-coreml.py"
)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model-name",
        type=str,
        help="name of model to convert (e.g. tiny, tiny.en, base, base.en, small, small.en, medium, medium.en, large-v1, large-v2, large-v3, large-v3-turbo)",
        required=True,
    )
    parser.add_argument(
        "--model-path",
    ...
    parser.add_argument(
        "--optimize-ane",
        type=bool,
        help="optimize for ANE execution (currently broken)",
        default=False,
    )
