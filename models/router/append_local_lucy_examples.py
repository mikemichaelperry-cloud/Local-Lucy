...
NEW_EXAMPLES: list[dict] = [
    # --- Personal / Family (LOCAL) ---
    {
        ...
        "metadata": {"source": "local_lucy_use_case", "category": "personal_family"},
    },
    {
    ...
    {
        "query": "Do I have any grandchildren",
        "labels": {
            "intent_family": "local_answer",
            "evidence_mode": "not_required",
            "route": "LOCAL",
    ...
    {
        "query": "Tell me about my dog Oscar",
        "labels": {
            "intent_family": "local_answer",
            "evidence_mode": "not_required",
            "route": "LOCAL",
    ...
    # --- Dog / Veterinary (EVIDENCE) ---
    {
        ...
        "metadata": {"source": "local_lucy_use_case", "category": "veterinary_dog"},
    },
    {
        "query": "What are the symptoms of parvo in dogs",
        "labels": {
            "intent_family": "current_evidence",
            "evidence_mode": "required",
            "route": "EVIDENCE",
    ...
    {
        "query": "Dog ear infection treatment",
        "labels": {
            "intent_family": "current_evidence",
            "evidence_mode": "required",
            "route": "EVIDENCE",
    ...
    {
        "query": "Best food for dogs with allergies",
        "labels": {
            "intent_family": "local_answer",
            "evidence_mode": "not_required",
            "route": "LOCAL",
    ...
    {
        "query": "Dog vaccination schedule",
        "labels": {
            "intent_family": "current_evidence",
            "evidence_mode": "required",
            "route": "EVIDENCE",
    ...
    # --- Electronics / Tube Database (LOCAL) ---
    {
        ...
        "metadata": {"source": "local_lucy_use_case", "category": "electronics"},
    },
    {
        "query": "Compare 6L6 and EL34 tubes",
        "labels": {
            "intent_family": "local_answer",
            "evidence_mode": "not_required",
            "route": "LOCAL",
    ...
    {
        "query": "What is the pinout of a 5U4G rectifier",
        "labels": {
            "intent_family": "local_answer",
            "evidence_mode": "not_required",
            "route": "LOCAL",
    ...
    {
        "query": "Difference between ceramic and electrolytic capacitors",
        "labels": {
            "intent_family": "local_answer",
            "evidence_mode": "not_required",
            "route": "LOCAL",
    ...
    # --- Coding / Programming (LOCAL) ---
    {
        ...
        "metadata": {"source": "local_lucy_use_case", "category": "programming"},
    },
    {
    ...
    {
        "query": "How do I sort a dictionary in Python",
        "labels": {
            "intent_family": "local_answer",
            "evidence_mode": "not_required",
            "route": "LOCAL",
    ...
    {
        "query": "Explain asyncio in Python",
        "labels": {
            "intent_family": "local_answer",
            "evidence_mode": "not_required",
            "route": "LOCAL",
    ...
    {
        "query": "Bash script to find large files",
        "labels": {
            "intent_family": "local_answer",
            "evidence_mode": "not_required",
            "route": "LOCAL",
    ...
    # --- Creative Writing (LOCAL) ---
    {
        ...
        "metadata": {"source": "local_lucy_use_case", "category": "creative_writing"},
    },
    {
        "query": "Tell me a story about a resistor",
        "labels": {
            "intent_family": "local_answer",
            "evidence_mode": "not_required",
            "route": "LOCAL",
    ...
    {
        "query": "Write a short story about a dog who becomes an engineer",
        "labels": {
            "intent_family": "local_answer",
            "evidence_mode": "not_required",
            "route": "LOCAL",
    ...
    # --- General Knowledge (LOCAL) ---
    {
        ...
        "metadata": {"source": "local_lucy_use_case", "category": "general_knowledge"},
    },
    {
    ...
    {
        "query": "What is entropy in physics",
        "labels": {
            "intent_family": "local_answer",
            "evidence_mode": "not_required",
            "route": "LOCAL",
    ...
    {
        "query": "Translate hello to Hebrew",
        "labels": {
            "intent_family": "local_answer",
            "evidence_mode": "not_required",
            "route": "LOCAL",
        ...
        "metadata": {"source": "local_lucy_use_case", "category": "translation"},
    },
    {
        "query": "How do you say good morning in Arabic",
        "labels": {
            "intent_family": "local_answer",
            "evidence_mode": "not_required",
            "route": "LOCAL",
    ...
    {
        "query": "Translate this sentence to Spanish",
        "labels": {
            "intent_family": "local_answer",
            "evidence_mode": "not_required",
            "route": "LOCAL",
    ...
    # --- Finance (AUGMENTED) ---
    {
        ...
        "metadata": {"source": "local_lucy_use_case", "category": "finance"},
    },
    {
    ...
    {
        "query": "Current inflation rate in the US",
        "labels": {
            "intent_family": "current_evidence",
            "evidence_mode": "required",
            "route": "AUGMENTED",
    ...
    # --- News (NEWS) ---
    {
        "query": "What is happening in the world today",
        "labels": {
            "intent_family": "current_evidence",
            "evidence_mode": "not_required",
            "route": "NEWS",
        ...
        "metadata": {"source": "local_lucy_use_case", "category": "news"},
    },
    {
        "query": "Latest news about Israel",
        "labels": {
    ...
    {
        "query": "Breaking news Middle East",
        "labels": {
            "intent_family": "news_request",
            "evidence_mode": "not_required",
            "route": "NEWS",
    ...
    {
        "query": "Latest developments in Ukraine",
        "labels": {
            "intent_family": "current_evidence",
            "evidence_mode": "not_required",
            "route": "NEWS",
    ...
    {
        "query": "What is the current situation in Gaza",
        "labels": {
            "intent_family": "current_evidence",
            "evidence_mode": "not_required",
            "route": "NEWS",
    ...
    # --- Weather (WEATHER) ---
    {
        ...
        "metadata": {"source": "local_lucy_use_case", "category": "weather"},
    },
    {
    ...
    {
        "query": "Temperature outside right now",
        "labels": {
            "intent_family": "current_evidence",
            "evidence_mode": "not_required",
            "route": "WEATHER",
    ...
    # --- Time (TIME) ---
    {
        ...
        "metadata": {"source": "local_lucy_use_case", "category": "time"},
    },
    {
        "query": "Current time in Sydney",
        "labels": {
            "intent_family": "current_evidence",
            "evidence_mode": "not_required",
            "route": "TIME",
