...
HOLDOUT: list[dict] = [
    ...
    {
        "query": "Explain Einstein's theory of relativity in simple terms.",
        "expected_route": "LOCAL",
        "category": "general_knowledge",
    },
    {
        "query": "How does a refrigerator keep food cold?",
        "expected_route": "LOCAL",
        "category": "general_knowledge",
    },
    # ---- LOCAL: history ----------------------------------------------------
    ...
    {
        "query": "Describe the causes of World War I.",
        "expected_route": "LOCAL",
        "category": "history",
    },
    {
        "query": "Why is the Magna Carta considered important in history?",
        "expected_route": "LOCAL",
        "category": "history",
    },
    {
        "query": "Which army was victorious at the Battle of Waterloo?",
        "expected_route": "LOCAL",
        "category": "history",
    },
    {
        "query": "Describe the French Revolution and its effects.",
        "expected_route": "LOCAL",
        "category": "history",
    },
    ...
    {
        "query": "What is the difference between capitalism and socialism?",
        "expected_route": "LOCAL",
        "category": "conceptual",
    },
    {"query": "How does a blockchain work?", "expected_route": "LOCAL", "category": "conceptual"},
    {
        "query": "What does deterrence mean in foreign policy?",
        "expected_route": "LOCAL",
        "category": "conceptual",
    },
    ...
    {
        "query": "What is your opinion on Keynesian economics?",
        "expected_route": "LOCAL",
        "category": "opinion",
    },
    {
        "query": "Critique the arguments for universal basic income.",
        "expected_route": "LOCAL",
        "category": "opinion",
    },
    {
        "query": "Speculate on the future of remote work.",
        "expected_route": "LOCAL",
        "category": "opinion",
    },
    {
        "query": "Did the Apollo missions really land on the moon?",
        "expected_route": "LOCAL",
        "category": "conspiracy",
    },
    {
        "query": "What do you think about conspiracy theories?",
        "expected_route": "LOCAL",
        "category": "opinion",
    },
    ...
    {
        "query": "Who designed and built you?",
        "expected_route": "LOCAL",
        "category": "self_reference",
    },
    {
        "query": "Can you help me write software?",
        "expected_route": "LOCAL",
        "category": "self_reference",
    },
    # ---- LOCAL: finance advice ---------------------------------------------
    {
        "query": "Should I pay off my mortgage early?",
        "expected_route": "LOCAL",
    ...
    {
        "query": "Explain dollar-cost averaging as an investment strategy.",
        "expected_route": "LOCAL",
        "category": "finance_advice",
    },
    ...
    {
        "query": "What is a good bodyweight workout routine?",
        "expected_route": "LOCAL",
        "category": "lifestyle",
    },
    ...
    {
        "query": "What is the current score in the Lakers game?",
        "expected_route": "AUGMENTED",
        "category": "live_event",
    },
    {
        "query": "Is it true that interest rates are rising this year?",
        "expected_route": "AUGMENTED",
        "category": "current_fact_reasoning",
    },
    {
        "query": "Is the latest iPhone a big improvement over last year's?",
        "expected_route": "AUGMENTED",
        "category": "latest_release",
    },
    # ---- NEWS --------------------------------------------------------------
    ...
    {
        "query": "Give me the latest news about climate change.",
        "expected_route": "NEWS",
        "category": "news",
    },
    {"query": "Breaking news from Ukraine.", "expected_route": "NEWS", "category": "news"},
    {
        "query": "What were the main events in the Middle East yesterday?",
        "expected_route": "NEWS",
        "category": "news",
    },
    {"query": "Any live updates on the election?", "expected_route": "NEWS", "category": "news"},
    {
        "query": "Give me the latest updates on the Israel-Gaza war.",
        "expected_route": "NEWS",
        "category": "current_conflict",
    },
    # ---- TIME --------------------------------------------------------------
    {
        "query": "What is the time now in Tokyo, Japan?",
        "expected_route": "TIME",
        "category": "time",
    },
    ...
    {
        "query": "How hot will it be in Phoenix this weekend?",
        "expected_route": "WEATHER",
        "category": "weather",
    },
    {
        "query": "Is it snowing in Denver right now?",
        "expected_route": "WEATHER",
        "category": "weather",
    },
    ...
    {
        "query": "My dog is vomiting and lethargic, what should I do?",
        "expected_route": "EVIDENCE",
        "category": "veterinary_evidence",
    },
    {
        "query": "Is tadalafil safe for heart patients?",
        "expected_route": "EVIDENCE",
        "category": "medical_evidence",
    },
    {
        "query": "What is the recommended dosage of ibuprofen for a child?",
        "expected_route": "EVIDENCE",
        "category": "medical_evidence",
    },
    {
        "query": "Provide evidence that exercise reduces anxiety.",
        "expected_route": "EVIDENCE",
        "category": "medical_source_request",
    },
    {
        "query": "Find peer-reviewed studies on metformin and longevity.",
        "expected_route": "EVIDENCE",
        "category": "medical_source_request",
    },
    # ---- FINANCE -----------------------------------------------------------
    ...
    {
        "query": "What is the current exchange rate for EUR to USD?",
        "expected_route": "FINANCE",
        "category": "finance",
    },
    {
    ...
    {
        "query": "How much is Ethereum trading for today?",
        "expected_route": "FINANCE",
        "category": "finance",
    },
]
