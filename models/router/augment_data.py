...
"""
    try:
        ...
        lines = [line for line in lines if len(line) > 10 and not line.lower().startswith(("here", "sure", "below", "the"))]
        return lines[:n]
...
def create_augmented_dataset(output_path: str = "augmented_training.jsonl", target_total: int = 1000):
    ...
    seed_examples = [
        ...
        ("How does a transformer neural network work?", "technical_explanation", "LOCAL_WITH_FALLBACK"),
        ...
        ("How does garbage collection work in Java?", "technical_explanation", "LOCAL_WITH_FALLBACK"),
        ("Explain the math behind Fourier transforms", "technical_explanation", "LOCAL_WITH_FALLBACK"),
    ...
    while len(all_examples) < target_total:
        ...
        all_examples.append({
            ...
            "metadata": {"source": "duplicated", "original": ex["metadata"].get("original", ex["query"])}
        })
